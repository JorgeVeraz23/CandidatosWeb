...
import { getInspectionOrders } from 'app/redux/actions/CatalogueActions';
...
export default function InspectionOrderSelect(props: Props) {
    const {
        value,
        placeholder = "Select...",
        isSearchable = true,
    ...
    const state = useAppSelector(state => state.catalogueInspectionOrder);
